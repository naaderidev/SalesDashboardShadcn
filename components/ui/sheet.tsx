...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-sidebar text-sidebar-foreground border-sidebar-border shadow-xl transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
